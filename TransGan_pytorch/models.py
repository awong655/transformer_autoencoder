...
class Generator(nn.Module):
    def __init__(self, depth1=1, depth2=1, depth3=1, initial_size=7, dim=128, heads=1, mlp_ratio=4, drop_rate=0.5):#,device=device):
        ...
        self.positional_embedding_1 = nn.Parameter(torch.zeros(1, (initial_size**2), dim))
        self.positional_embedding_2 = nn.Parameter(torch.zeros(1, (initial_size*2)**2, dim//4))
        self.positional_embedding_3 = nn.Parameter(torch.zeros(1, (initial_size*4)**2, dim//16))
